...
void Adafruit_BNO055::setGRange(int range) {

  byte rangeConfigByte;
  switch (range) {
    case 2:
      rangeConfigByte = 0b00;
      break;
    case 4:
      rangeConfigByte = 0b01;
      break;
    case 8:
      rangeConfigByte = 0b10;
      break;
    case 16:
      rangeConfigByte = 0b11;
      break;
    default:
      rangeConfigByte = 0b00;
      break;
  ...
  byte config = read8(BNO055_ACC_CONFIG_ADDR);
  config &= ~(rangeConfigByte);
  config |= rangeConfigByte;
